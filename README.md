...
1. The core features of Node.js and Express and why they are useful.
  ...
  Node.js is useful because it allows us to write javascript outside of the browser. We can use javascript to write back-end code similarly to how we use it to write code for the front end. Express is useful because it allows us to simplify our code writing by working with JSON, serve static content, and it is compatible with other middleware.
